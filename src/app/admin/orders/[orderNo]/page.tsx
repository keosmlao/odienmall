                  ...
                  <span className="flex items-center gap-2">
                    ...
                    {order.phone && (
                      <a
                        ...
                        title="WhatsApp"
                        className="inline-flex h-6 w-6 items-center justify-center rounded-full bg-[#25D366] text-white transition hover:brightness-110"
                      >
...
function nextStepText(status: string) {
  const text: Record<string, string> = {
    ...
    awaiting_confirmation: "ຊຳລະ QR ແລ້ວ — ເລືອກສາງ ແລ້ວກົດ ອອກບິນ (34→44)",
