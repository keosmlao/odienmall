  ...
  return (
    <div className="flex min-h-[65vh] w-full flex-col items-center justify-center gap-4 py-12" aria-label="ກຳລັງໂຫຼດ">
      <div className="relative flex h-14 w-14 items-center justify-center">
        ...
        <span className="absolute inline-flex h-full w-full animate-ping rounded-full bg-orange-50 opacity-75" />
      ...
      <div className="flex flex-col items-center gap-1 text-center">
        <span className="animate-pulse text-xs font-black uppercase tracking-[0.2em] text-slate-500">
          ODIENMALL STUDIO
        </span>
